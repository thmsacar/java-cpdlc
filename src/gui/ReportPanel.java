...
import gui.report.ReportForm;
import gui.report.ReportLevelForm;
import gui.report.ReportPositionForm;
import gui.report.ReportSpeedForm;
...
public class ReportPanel extends JPanel {
    ...
    public ReportPanel(CpdlcService service, Runnable onBack, Runnable onSend) {
    ...
    private void setupUI() {
        ...
        cardContainer.add(createReportFormPanel("LEVEL", new ReportLevelForm()), "LEVEL");
        cardContainer.add(createReportFormPanel("SPEED", new ReportSpeedForm()), "SPEED");
        cardContainer.add(createReportFormPanel("POSITION", new ReportPositionForm()), "POSITION");
    ...
    private JPanel createMenuPanel() {
        ...
        menu.add(createMenuButton("POSITION", "POSITION"));
    ...
    private JPanel createReportFormPanel(String title, ReportForm form) {
        JPanel p = new JPanel(new BorderLayout(0, 10));
